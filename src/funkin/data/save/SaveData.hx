...
import funkin.input.FunkinControls.ControlMappings;
...
typedef SaveData =
{
   ...
   * PlayState Progress.
   */
  var progress:SaveProgressData;

  /**
   * Options.
   */
  var options:SaveOptionData;
...
typedef SaveProgressData =
{
   ...
   */
  var highscores:SaveHighscoreData;
}

typedef SaveHighscoreData =
{
  /**
